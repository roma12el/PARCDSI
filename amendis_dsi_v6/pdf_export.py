...
# ─── Palette couleurs — alignée avec l'application Streamlit ──────────────────
NAVY   = colors.HexColor("#1B2A3B")   # navy principal app
NAVY2  = colors.HexColor("#2D3E50")   # navy secondaire app
TEAL   = colors.HexColor("#2980B9")   # bleu app
ACCENT = colors.HexColor("#C8102E")   # rouge Amendis (couleur principale)
CORAL  = colors.HexColor("#E8415B")   # rouge clair app
GOLD   = colors.HexColor("#E67E22")   # orange app
GREEN  = colors.HexColor("#27AE60")   # vert app
ORANGE = colors.HexColor("#F39C12")   # orange clair app
RED    = colors.HexColor("#C8102E")   # rouge urgent (même que ACCENT)
LIGHT  = colors.HexColor("#F2F2F2")   # gris clair app
BORDER = colors.HexColor("#E2E8F0")   # bordure
TEXT   = colors.HexColor("#2D2D2D")   # texte app
MUTED  = colors.HexColor("#64748B")   # gris moyen app
WHITE  = colors.white
LIGHT_TEAL = colors.HexColor("#EBF5FB")   # bleu très clair
LIGHT_CORAL= colors.HexColor("#FDEDEC")   # rouge très clair
LIGHT_GREEN= colors.HexColor("#EAFAF1")   # vert très clair
LIGHT_NAVY = colors.HexColor("#EAF0F6")   # navy très clair
